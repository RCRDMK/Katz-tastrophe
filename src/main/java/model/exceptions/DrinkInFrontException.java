...
/**
 * This exception gets thrown when there's a drink in front of the direction in which the character looks
 *
 * @since 05.11.2021
 */

public class DrinkInFrontException extends Exception {
}
